<div class="container mt-4">
    ...
    <form method="POST" action="">
        ...
        <div class="mb-3">
            ...
            <input type="datetime-local" name="departure_datetime" id="departure_datetime" class="form-control" 
        ...
        <div class="mb-3">
            ...
            <input type="datetime-local" name="arrival_datetime" id="arrival_datetime" class="form-control"
        ...
        <div class="mb-3">
            ...
            <input type="number" name="total_seats" id="total_seats" class="form-control" 
                   value="<?= $trip->total_seats ?>" min="1" max="10" required>
        </div>
